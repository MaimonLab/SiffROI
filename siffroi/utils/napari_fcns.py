...
class _NapariLike():
    ...
    def __init__(self, shapelike  = None):
        """
...
def _largest_polygon_tuple_from_viable(polys_list : list[np.ndarray], n_polygons : int = 1):
    """
...
def _largest_ellipse_tuple_from_viable(ellipse_list : list[np.ndarray], n_ellipses : int = 1):
    """
...
def napari_shapes_to_holoviews(shapesLayer : Shapes, inherit_properties = True):
    """
